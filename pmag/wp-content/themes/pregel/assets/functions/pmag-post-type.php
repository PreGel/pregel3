...
function magazine_custom_post() { 
	...
	register_post_type( 'pmag_article', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('P Mag Articles', 'jointswp'), /* This is the Title of the Group */
			...
			'edit_item' => __('Edit Articles', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Article', 'jointswp'), /* New Display Title */
			'view_item' => __('View Article', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Articles', 'jointswp'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This holds the pmag articles', 'jointswp' ), /* Custom Type Description */
			'public' => true,
			...
			'has_archive' => 'pmag_article', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type('category', 'pmag_article');
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'pmag_article');
