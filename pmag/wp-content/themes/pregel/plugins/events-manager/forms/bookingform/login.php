 ...
 */
?>
<div class="em-booking-login reveal" id="myLogin" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  ...
  <span aria-hidden="true">&times;</span>
	...
	<input class="button" type="submit" name="wp-submit" id="em_wp-submit" value="<?php esc_html_e('Log In', 'dbem'); ?>" tabindex="100" />
