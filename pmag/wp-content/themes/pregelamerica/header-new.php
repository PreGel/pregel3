<!doctype html>
  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/styles/ILstyles.css" />

		<link rel="stylesheet" href="<?php bloginfo( 'template_url' ); ?>/styles/lean-slider.css" type="text/css" /> 
