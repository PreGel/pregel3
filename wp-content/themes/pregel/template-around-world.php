			...
			<div id="pg-locations-section">
				<div class="row" id="pg-about-content-row">
					...
					<div id="location-links" class="small-12 medium-12 large-12 columns">
					 <div class="row">
					  <div class="large-6 medium-6 text-left columns">
						<h4><a href="hhttp://www.pregel.com/about-us/pregel-around-the-world/" target="_blank">PreGel Austria</a></h4>
					  </div>
					  <div class="large-6 medium-6 text-left columns">
						<ul class="locations-social">
							<li>
					...
					<div id="location-links" class="small-12 medium-12 large-12 columns">
					 <div class="row">
					  <div class="large-6 medium-6 text-left columns">
						<h4><a href="http://www.pregel.com/about-us/pregel-around-the-world/" target="_blank">PreGel Germany</a></h4>
					  </div>
					  <div class="large-6 medium-6 text-left columns">
						<ul class="locations-social">
							<li>
					...
					<div id="location-links" class="small-12 medium-12 large-12 columns">
					 <div class="row">
					  <div class="large-6 medium-6 text-left columns">
						<h4><a href="http://www.pregel.com/about-us/pregel-around-the-world/" target="_blank">PreGel Switerland</a></h4>
					  </div>
					  <div class="large-6 medium-6 text-left columns">
						<ul class="locations-social">
							<li>
