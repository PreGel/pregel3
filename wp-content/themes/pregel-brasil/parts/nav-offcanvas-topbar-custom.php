				...
				<div class="top-bar-left show-for-large">
					<div class="nav-table">
						...
						<ul id="menu-main-left-1" class="dropdown menu float-left" data-dropdown-menu="">
							...
							<a href="https://mexico.pregel-itc.com/training">TREINAMENTO</a>
							...
							<ul class="menu arrow-box submenu is-dropdown-submenu first-sub vertical" data-submenu="" aria-hidden="true" role="menu">
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://brasil.pregel-itc.com/treinamento/pesquisar-classes/">Pesquisar Classes</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://brasil.pregel-itc.com/aulas/">Aulas</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://mexico.pregel-itc.com/training/calendar/">Calendário</a></li>
								<!-- <li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="">Cursos</a></li> -->
								...
								<!-- <li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="">Preguntas</a></li> -->
