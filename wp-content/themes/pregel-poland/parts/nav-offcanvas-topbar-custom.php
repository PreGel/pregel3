				...
				<div class="top-bar-left show-for-large">
					<div class="nav-table">
						...
						<ul id="menu-main-left-1" class="dropdown menu float-left" data-dropdown-menu="">
							...
							<a id="strona" href="/">STRONA GŁÓWNA</a>
							</li>
							
							<!-- use this to pull menu from magento -->
							<?php the_block('wp_prod_menu'); ?>

							<!-- have to add manually so that products can be in secind spot? -->
							<li class="menu-item menu-item-type-post_type menu-item-object-page" role="menuitem" aria-haspopup="true" aria-selected="false" aria-expanded="false" aria-label="Szkolenia" data-is-click="false">
							<a href="https://pregel.pl/training">SZKOLENIA</a>
