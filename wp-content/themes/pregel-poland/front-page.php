	...
	<div id="content">
		...
		<div id="product-bar">
			<div class="row expanded">
				<a href="#"><div class="large-3 small-6 columns link gelato"><h3>Lody</h3></div></a>
				<a href="#"><div class="large-3 small-6 columns link pastry"><h3>Cukiernictwo</h3></div></a>
				<a href="#"><div class="large-3 small-6 columns link froyo"><h3 id="soft-serve">Softy</h3></div></a>
				<a href="#"><div class="large-3 small-6 columns link bev"><h3>Napoje</h3></div></a>
			</div>
		</div>
