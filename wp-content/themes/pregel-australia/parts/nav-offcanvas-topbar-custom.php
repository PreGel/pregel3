				...
				<div class="top-bar-left show-for-large">
					<div class="nav-table">
						...
						<ul id="menu-main-left-1" class="dropdown menu float-left" data-dropdown-menu="">
							...
							<a href="https://pregel.com.au/training/training-classes/">Training</a>
							...
							<ul class="menu arrow-box submenu is-dropdown-submenu first-sub vertical" data-submenu="" aria-hidden="true" role="menu">
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://australia.pregel-itc.com/training/schedule-registration/">Class Schedule</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://australia.pregel-itc.com/training/training-center-instructors-staff/">Instructors &amp; Staff</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel.com.au/training/open-a-gelato-shop/">Open a Gelato Shop</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel.com.au/training/the-business-plan-for-opening-a-gelato-shop/">The Business Plan</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel.com.au/training/artisan-gelato-ingredients/">Artisan Gelato Ingredients</a></li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel.com.au/training/the-importance-of-gelato-and-pastry-training-courses/">Importance of Training</a></li>
								<!-- <li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel.com.au/training/training-classes/">Training Classes</a></li>
