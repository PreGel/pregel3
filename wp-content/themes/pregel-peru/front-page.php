<?php get_header(); ?>
	...
	<div id="content">
		<div id="intro">
			<?php masterslider("pgpr-home"); ?>
		</div>
		<div id="product-bar">
			<div class="row expanded">
				<a href="https://pregelperu.com/PGPE_ProductCatalog.pdf#page=5"><div class="large-4 small-12 columns link gelato"><h3>Helado</h3></div></a>
				<a href="https://pregelperu.com/PGPE_ProductCatalog.pdf#page=8"><div class="large-4 small-12 columns link froyo"><h3>Helado Suave</h3></div></a>
				<a href="https://pregelperu.com/PGPE_ProductCatalog.pdf"><div class="large-4 small-12 columns link pastry"><h3>Pastelería <span>y</span><br> Confitería</h3></div></a>
