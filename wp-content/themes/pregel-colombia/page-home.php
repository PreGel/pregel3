	...
	<div id="content">
		...
		<div id="product-bar">
			<div class="row expanded">
				<a href="https://productos.pregelmexico.com/pgmx/productos/gelato-sorbetto.html"><div class="large-4 small-12 columns link gelato"><h3>Gelato</h3></div></a>
				<a href="https://productos.pregelmexico.com/pgmx/productos/helado-suave.html"><div class="large-4 small-12 columns link froyo"><h3 id="soft-serve">Helado Suave</h3></div></a>
				<a href="https://productos.pregelmexico.com/pgmx/productos/pasteleria-confeteria.html"><div class="large-4 small-12 columns link pastry"><h3>Pastelería <span>y</span><br>Confitería</h3></div></a>
				<!-- <a href=""><div class="large-3 small-6 columns link bev"><h3>Bebidas</h3></div></a> -->
			</div>
		</div>
