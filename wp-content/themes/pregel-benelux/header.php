  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<?php if ( ICL_LANGUAGE_CODE=='nl' ) {
			get_template_part( 'parts/nav', 'title-bar-custom-nl' );
			} elseif ( ICL_LANGUAGE_CODE=='en' ) {
			get_template_part( 'parts/nav', 'title-bar-custom-en' );
			} elseif ( ICL_LANGUAGE_CODE=='fr' ) {
			get_template_part( 'parts/nav', 'title-bar-custom-fr' );
			} else {
			get_template_part( 'parts/nav', 'title-bar-custom-nl' );
 			}?>
				...
				<div class="off-canvas-content" data-off-canvas-content>
					...
					<header class="header" role="banner">
						 ...
						 <!-- This navs will be applied to the topbar, above all content 
							  ...
							  <?php if ( ICL_LANGUAGE_CODE=='nl' ) {
								get_template_part( 'parts/nav', 'offcanvas-topbar-custom-nl' );
								} elseif ( ICL_LANGUAGE_CODE=='en' ) {
								get_template_part( 'parts/nav', 'offcanvas-topbar-custom-en' );
								} elseif ( ICL_LANGUAGE_CODE=='fr' ) {
								get_template_part( 'parts/nav', 'offcanvas-topbar-custom-fr' );
								} else {
								get_template_part( 'parts/nav', 'offcanvas-topbar-custom-nl' );
					 			}?>
