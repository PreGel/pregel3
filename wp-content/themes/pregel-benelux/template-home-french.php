<?php
/*
Template Name: Benelux Home - French
*/
?>
<?php get_header(); ?>
	...
	<div id="content">
		<div id="intro">
			<?php masterslider("pgbx-home-french"); ?>
		</div>
		<div id="product-bar">
			<div class="row expanded">
				...
				<a href="https://pgbxproducts.pregel2.com/en-pgbx/products/pastry-confections.html"><div class="large-3 small-6 columns link pastry"><h3>Pastry</h3></div></a>
				<a href="https://pgbxproducts.pregel2.com/en-pgbx/products/soft-serve.html"><div class="large-3 small-6 columns link froyo"><h3 id="soft-serve">Soft&nbsp;Serve</h3></div></a>
				<a href="https://pgbxproducts.pregel2.com/en-pgbx/products/specialty-beverages.html"><div class="large-3 small-6 columns link bev"><h3>Beverages</h3></div></a>
			</div>
		</div>
