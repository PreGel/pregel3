	...
	<div id="content">
		...
		<div id="product-bar">
			<div class="row expanded">
				<a href="#"><div class="large-3 small-6 columns link gelato"><h3>Helado</h3></div></a>
				<a href="#"><div class="large-3 small-6 columns link pastry"><h3>Pastry</h3></div></a>
				<a href="#"><div class="large-3 small-6 columns link froyo"><h3 id="soft-serve">Helado Sauve</h3></div></a>
				<a href="#"><div class="large-3 small-6 columns link bev"><h3>Beverages</h3></div></a>
			</div>
		</div>
